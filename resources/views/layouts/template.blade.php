...
<link rel="stylesheet" type="text/css" href="{{asset('ecom/styles/main_styles.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('ecom/styles/responsive.css')}}">
</head>
...
<script type="text/javascript">
    Stripe.setPublishableKey('pk_test_YGrfa4lhSBO4BJcpv3nJ4va0');
</script>
